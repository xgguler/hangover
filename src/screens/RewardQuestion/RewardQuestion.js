...
export const rewardQuestionAnswerLoadActions = actionTypes(
  'REWARD_QUESTION_ANSWER_LOAD'
);
...
class RewardQuestion extends Component {
  constructor(props) {
    ...
    this.postUserRewardQuestionAnswer = this.postUserRewardQuestionAnswer.bind(
      this
    );
  }
  ...
  postUserRewardQuestionAnswer(questionId, answerId) {
    let requestBody = {
      UserRewardQuestionAnswer: [
        {
    ...
    this.props.dispatch({
      [CALL_API]: {
        type: rewardQuestionAnswerLoadActions,
        entity: '/rest/form/gift/Entity.xsjs',
        method: 'post',
        data: requestBody,
      },
    });
      ...
      <Container>
        <Content>
          ...
          <Button
            ...
            light
            onPress={() =>
              this.postUserRewardQuestionAnswer(questionID, answerID1)
            }
          ...
          <Button
            ...
            light
            onPress={() =>
              this.postUserRewardQuestionAnswer(questionID, answerID2)
            }
            style={styles.answerButton}>
          ...
          <Button
            ...
            light
            onPress={() =>
              this.postUserRewardQuestionAnswer(questionID, answerID3)
            }
            style={styles.answerButton}>
          ...
          <Button
            ...
            light
            onPress={() =>
              this.postUserRewardQuestionAnswer(questionID, answerID4)
            }
            style={styles.answerButton}>
...
export default connect(mapStateToProps)(RewardQuestion);
