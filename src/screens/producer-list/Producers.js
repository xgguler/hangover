    ...
    const items = [
      {
        name: "Beyoğlu Manavı",
        url:
          "https://cdn.gunes.com/Documents/Gunes/Images/2018/09/26/640x360_5e195397-52f9-4cef-9f68-e1e668ac71c7.jpg",
      },
      {
        name: "Cihangir Manavı",
        url:
          "https://cdn.gunes.com/Documents/Gunes/Images/2018/09/26/640x360_5e195397-52f9-4cef-9f68-e1e668ac71c7.jpg",
      },
      {
        name: "Çukurcuma Manavı",
        url:
          "https://cdn.gunes.com/Documents/Gunes/Images/2018/09/26/640x360_5e195397-52f9-4cef-9f68-e1e668ac71c7.jpg",
      },
      {
        name: "Tarihi Firuzağa Manavı",
        url:
          "https://cdn.gunes.com/Documents/Gunes/Images/2018/09/26/640x360_5e195397-52f9-4cef-9f68-e1e668ac71c7.jpg",
      },
    ];
            ...
            <FlatGrid
              ...
              renderItem={({ item, index }) => (
                <TouchableOpacity>
                  <Card
                    onPress={() =>
                      this.props.navigation.navigate("ProducerProfile")
                    }
                  >
                    <CardItem>
                      <Left>
                    ...
                    <CardItem cardBody>
                      <Image
                        source={{ uri: item.url }}
                        style={{ height: 70, width: 40, flex: 1 }}
                      />
                    </CardItem>
                    <CardItem>
                      <Left>
